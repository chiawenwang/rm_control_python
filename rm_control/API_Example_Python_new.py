...
def demo7(robot):
    ...
    #   正解
    joint1 = [-25.0, 49.99700164794922, -130.00100708007812, -79.99800109863281, -20.0, -24.996000289916992, 30.0]
    joint2 = [  11.21 ,  51.42, -177.13 , -77.12, -160.54  ,  1.54, -164.1 ]
    pose1 = Arm.Algo_Forward_Kinematics(joint1)
    pose2 = Arm.Algo_Forward_Kinematics(joint2)
    ...
    res = Arm.Algo_Inverse_Kinematics(joint1, pose1, 1)
...
if __name__ == "__main__":
    ...
    robot = Arm(RM65, "192.168.31.106", callback)
