...
def demo5(robot):
    ...
    # 运动到透传的第一个点位
    num_lines = len(point)
    robot.Movej_Cmd(point[0], 5, 0, 0, True)
...
def demo7(robot):
    #   初始位置
    joint = [-44, 52, -62, -70, -25, -30 ,43]
    # compute_pose[0] += 0.5
    compute_pose  = [0.338, 0.526, -0.145, 3, -0.459, 0.406]
    print(f'逆解输入：{compute_pose}')
...
if __name__ == "__main__":
    ...
    robot = Arm(RM75, "192.168.31.106", callback)
